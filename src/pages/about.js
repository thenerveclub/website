  ...
  return (
    <Layout path={props.location.pathname}>
      ...
      <StyledSectionHeader style={{ fontFamily: "True" }}>{'RECOGNITION'}</StyledSectionHeader>
          ...
          <StyledButtonTop target="_blank" rel="noreferrer" href="https://www.nerveglobal.com/blog/blockland-solutions/">
              <span>Learn more</span>
            </StyledButtonTop>
          </GrantsCard>
        </StyledItemRow>
          ...
          <StyledSectionFlex id="contact" style={{ flexDirection: 'column' }}>
            ...
            <StyledButtonTop style={{ marginLeft: "12px" }} target="_blank" rel="noreferrer" href="https://twitter.com/nerveglobal_">
              <span>Twitter</span>
            </StyledButtonTop>
            <StyledButtonTop style={{ marginLeft: "12px" }} target="_blank" rel="noreferrer" href="https://www.linkedin.com/company/nerveglobal/">
              <span>LinkedIn</span>
            </StyledButtonTop>
            </div>
            </HideSmall>
      ...
      <StyledSectionFlex id="brand" style={{ flexDirection: 'column' }}>
        <p>
          ...
          <StyledButtonTop style={{ fontSize: "15px" }} target="_blank" rel="noreferrer" href="https://github.com/nerveglobal/brand-assets">
  ...
  return (
      <StyledSection>
        ...
        <StyledItemRow style={{ alignItems: 'center', justifyContent: 'center'}}>
          ...
          <GrantsCard style={{ minHeight: "11rem", minWidth: "20rem" }}>
            <StyledBodySubTitle>FIRST TO MARKET
            <p style={{ opacity: '0.6', fontSize: '16px', fontWeight: 400 }}>
          ...
          <GrantsCard style={{ minHeight: "11rem", minWidth: "20rem" }}>
            <StyledBodySubTitle>SMALL PROJECTS
            <p style={{ opacity: '0.6', fontSize: '16px', fontWeight: 400 }}>
...
const DeveloperSection2 = () => {
  return (
      <StyledSection>
        <StyledItemRow style={{ alignItems: 'center', justifyContent: 'center', marginTop: "-5rem", padding: '1rem auto 1rem auto' }}>
          <GrantsCard style={{ minHeight: "10rem", minWidth: "23rem" }}>
            <StyledBodySubTitle>EARN CRYPTO
            <p style={{ opacity: '0.6', fontSize: '16px', fontWeight: 400 }}>
          ...
          <GrantsCard style={{ minHeight: "10rem", minWidth: "23rem" }}>
            <StyledBodySubTitle>EASE OF USE
            <p style={{ opacity: '0.6', fontSize: '16px', fontWeight: 400 }}>
          ...
          <GrantsCard style={{ minHeight: "10rem", minWidth: "23rem" }}>
            <StyledBodySubTitle>INSTANT FUNDING
            <p style={{ opacity: '0.6', fontSize: '16px', fontWeight: 400 }}>
          ...
          <GrantsCard style={{ minHeight: "10rem", minWidth: "23rem" }}>
            <StyledBodySubTitle>ON DELIVERY
            <p style={{ opacity: '0.6', fontSize: '16px', fontWeight: 400 }}>
